...
/// Card variants
enum AppCardVariant { default_, elevated, outlined, filled }

/// App Card with specific configurations for common use cases
class AppCardWithConfig {
  ...
  /// Booking card for displaying booking information
  ...
  /// Info card for displaying general information
  static AppCard info({
    Key? key,
    required String title,
